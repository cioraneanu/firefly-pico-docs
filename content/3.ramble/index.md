...
<table>
  <tr>
    <td width="50%">1. Configure the iPhone <b>Action Button</b> to start the <code>docs/siri-shortcuts/pico-text-template-signed.shortcut</code> shortcut</td>
    <td width="50%">At the end of the day check your Rambles, interpret them, tweak anything you want and save everything in one go.</td>
  </tr>
  <tr>
    <td align="center">
